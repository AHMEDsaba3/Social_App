                      ...
                      child: Padding(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(image: NetworkImage(cubit.model!.cover??''),
                                fit: BoxFit.cover,
                              ),)),
                      ),
                    ),
                    ...
                    children: [
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('Posts',style: Theme.of(context).textTheme.bodyMedium)
                            ],
                          ),
                        ),
                      ),
                      Expanded(
                        child: InkWell(
                          ...
                          child: Column(
                            children: [
                              Text('240',style: Theme.of(context).textTheme.labelLarge),
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          child: Column(
                            children: [
                              Text('10K',style: Theme.of(context).textTheme.labelLarge),
                              Text('Followers',style: Theme.of(context).textTheme.bodyMedium)
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('Followings',style: Theme.of(context).textTheme.bodyMedium)
                            ],
                          ),
                        ),
                      ),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: OutlinedButton(onPressed: () {},
                                ...
                                child:Text('Add Photo',style: Theme.of(context).textTheme.bodyMedium  ,) ),
                          ),
